...
def main():
    return jsonify({
        ...
        "redirect_url": "http://192.168.1.100:80/main/main.html"
    })
...
def search_results():
    ...
    return jsonify({
        "flights":flights,
        "redirect_url":"http://192.168.1.100:80/main/main_list.html"
    })
...
def flight_detail(flight_id):
    ...
    return jsonify({
        ...
        "redirect_url": "http://192.168.1.100:80/main/main_list_detail.html"
    })
...
def book_flight():
    try:
        ...
        response_data = {
            "flights": flights,
            "redirect_url": "http://192.168.1.100:80/pay/pay.html"
        }

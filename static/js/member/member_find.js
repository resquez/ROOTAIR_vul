...
async function requestResetCode() {
    ...
    const response = await fetch('http://10.0.3.150:5000/api/member/request-reset-code', {  // ✅ 엔드포인트 변경
        method: 'POST',
...
async function verifyResetCode() {
    ...
    const response = await fetch('http://10.0.3.150:5000/api/member/verify-reset-code', {  // ✅ 엔드포인트 변경
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
async function sendnewpassword(newPassword) {
    try {
        const response = await fetch('http://10.0.3.150:5000/api/member/reset-password', {  // ✅ 엔드포인트 변경
            method: 'POST',
            headers: { 'Content-Type': 'application/json',

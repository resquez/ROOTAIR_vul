...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (flightId && userId) {
	fetch(`http://192.168.1.101:5000/api/pay/pay_info?flight_id=${flightId}&user_id=${userId}&total_price=${totalPrice}&final_mileage=${finalMileage}&remaining_balance=${remainingBalance}`)
